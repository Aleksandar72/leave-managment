...
namespace LeaveManagment.Data.Migrations
{
    ...
    [Migration("20201007084542_deleteVMTable")]
    partial class deleteVMTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LeaveManagment.Data.LeaveTypes", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LeaveManagment.Data.LeaveAllocation", b =>
                {
                    ...
                    b.HasOne("LeaveManagment.Data.LeaveTypes", "LeaveType")
                        .WithMany()
            ...
            modelBuilder.Entity("LeaveManagment.Data.LeaveRequest", b =>
                {
                    ...
                    b.HasOne("LeaveManagment.Data.LeaveTypes", "LeaveTypes")
                        .WithMany()
                        .HasForeignKey("LeaveTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
